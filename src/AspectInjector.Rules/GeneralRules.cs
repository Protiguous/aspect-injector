	...
	public static class GeneralRules
	{
		...
		public static readonly Rule Info =
			Make("AI_INFO",
				"Info message",
				"{0}",
				"Thanks for using https://github.com/Protiguous/aspect-injector",
				RuleSeverity.Info);

		public static readonly Rule CompilationMustSecceedIfNoOtherErrors =
			Make("AI_ERR0",
				"Aspect Injector encounters error it wasn't expected",
				"{0}. Please submit an issue to https://github.com/Protiguous/aspect-injector",
				"Aspect Injector encounters error it wasn't expected. Please submit an issue to https://github.com/Protiguous/aspect-injector");
		...
		public static readonly Rule UnknownCompilationOption =
			Make("AI_ERR1",
				...
				"Aspect Injector encounters error it wasn't expected. If AspectInjector is up to date - please submit an issue to https://github.com/Protiguous/aspect-injector");

		public static readonly Rule UnexpectedCompilerBehaviour =
			Make("AI_ERR2",
				"Aspect Injector encounters unexpected behaviour",
				"{0}. Please submit an issue to https://github.com/Protiguous/aspect-injector",
				"Aspect Injector encounters behavior it wasn't expected. Please submit an issue to https://github.com/Protiguous/aspect-injector");
		...
		internal static Rule Make(string id, string title, string message, string description, RuleSeverity severity = RuleSeverity.Error)
			=> new(id, title, message, severity, description,
				$"https://github.com/Protiguous/aspect-injector/blob/master/docs/errors/{id}.md");
